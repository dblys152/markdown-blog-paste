...
.conversion-options .section-title { margin-bottom: 0; }
...
.conversion-options span { display: grid; gap: 4px; }
.conversion-options strong { color: #344054; font-size: 13px; }
