...
# -----------------------------
# Markdown -> HTML preview converter for Naver Blog
# -----------------------------
...
HTML_LANG = "ko"
HTML_CHARSET = "UTF-8"
USAGE_MESSAGE = "사용법: python3 convert_for_naver.py ./post.md"
...
def add_editor_blank_lines(html_text: str) -> str:
    ...
    # 코드블록용 spacer도 마지막에 추가합니다.
    # 코드블록 변환 시 바로 <p>를 넣으면 위 </p> 치환에서 중복 spacer가 생길 수 있습니다.
...
def render_markdown(markdown_text: str) -> str:
    """Markdown 문자열을 네이버 블로그 복붙용 HTML 본문으로 변환합니다."""
    ...
    body_html = convert_code_blocks_for_naver(body_html)

    return add_editor_blank_lines(body_html)
