...
ACCOUNT_CONFIRMATION_TOKEN_BYTES = 32
...
class SecureAccountConfirmationTokenManager:
    def generate(self) -> GeneratedAccountConfirmationToken:
        raw = secrets.token_urlsafe(ACCOUNT_CONFIRMATION_TOKEN_BYTES)
        return GeneratedAccountConfirmationToken(raw=raw, token_hash=self.hash(raw))
