...
class PasswordResetToken:
    ...
    def use(self, used_at: datetime) -> "PasswordResetToken":
    ...
    def revoke(self, revoked_at: datetime) -> "PasswordResetToken":
        if self.used_at is not None or self.revoked_at is not None:
            return self
...
class PasswordResetUnavailableError(PasswordResetError):
    pass
